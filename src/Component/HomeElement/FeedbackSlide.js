          ...
          <SwiperSlide>
            <div className="">
              <p className=" text-center   p-10 clip-student">
                “This course understood me the full concept of web development
                and it was very helpful and I understood things so easily. A
                beginner in this field will surely be benefited. Also the extra
                material is very helpful. This helped me take up full stack web
                development.”
              </p>
              <div
          ...
          <SwiperSlide>
            <div className="">
              <p className=" text-center   p-10 clip-student">
                ...
                so unique and amazing. If anyone is really dedicated to learn
                and do something ,they should go for this course.“
              </p>
              <div
                className=" w-28  h-28 rounded-full bg-no-repeat bg-cover bg-current mx-auto mt-16"
