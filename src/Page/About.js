    ...
    <>
      ...
      <div className=" sm:py-24 py-10 lg:mt-24 mt-28 px-4">
        <div className="container mx-auto">
          ...
          <p className=" font-rly sm:text-xl p-2 font-normal text-black text-justify mb-4">
          ...
          <h2 className=" text-black  sm:text-2xl text-center font-bold font-slab sm:mb-8   sm:mt-12">
            Who We Are
          </h2>
          <p className=" font-rly sm:text-xl p-2 font-normal text-black text-justify mb-4">
          ...
          <p className=" font-rly sm:text-xl p-2 font-normal text-black text-justify">
